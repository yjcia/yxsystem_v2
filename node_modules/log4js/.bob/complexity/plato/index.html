...
<div class="container aggregate-stats">
    ...
    <div class="row">
        <div class="col-md-6">
            <h2 class="header">Total/Average Lines <i class="icon icon-info-sign" rel="popover" data-placement="top"
                                                      data-trigger="hover" data-content="Source Lines of Code"
                                                      data-original-title="SLOC" data-container="body"></i></h2>

            <p class="stat">2648 / 115</p>
        </div>
        <div class="col-md-6">
            <h2 class="header">Average Maintainability <a
                    href="http://blogs.msdn.com/b/codeanalysis/archive/2007/11/20/maintainability-index-range-and-meaning.aspx"><i
                    class="icon icon-info-sign" rel="popover" data-placement="top" data-trigger="hover"
                    ...
                    data-original-title="Maintainability Index" data-container="body"></i></a></h2>
...
<div class="container overview">
    <div class="row">
        <h2 class="col-md-12">Maintainability <a
                href="http://blogs.msdn.com/b/codeanalysis/archive/2007/11/20/maintainability-index-range-and-meaning.aspx"><i
                class="icon icon-info-sign" rel="popover" data-placement="top" data-trigger="hover"
                data-content="A value between 0 and 100 that represents the relative ease of maintaining the code. A high value means better maintainability."
                data-original-title="Maintainability Index" data-container="body"></i></a></h2>
        ...
        <div class="col-md-12">
            <div id='chart_maintainability' class='chart js-chart'></div>
        </div>
    </div>
    <div class="row">
        <h2 class="col-md-12">Lines of code <i class="icon icon-info-sign" rel="popover" data-placement="top"
                                               data-trigger="hover" data-content="Source Lines of Code"
                                               data-original-title="SLOC" data-container="body"></i></h2>
    ...
    <div class="row">
        <h2 class="col-md-12">Estimated errors in implementation <a
                href="http://en.wikipedia.org/wiki/Halstead_complexity_measures"><i class="icon icon-info-sign"
        ...
        <ul class="file-list list-unstyled">
            ...
            <li class="col-md-12">
                <div class="row">
                    ...
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_appenders_categoryFilter_js/index.html">lib/appenders/categoryFilter.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_appenders_clustered_js/index.html">lib/appenders/clustered.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="9"
              data-sloc="138"
              data-bugs="0.80"
        ...
        <span class="col-md-8 file-chart js-file-chart"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_appenders_dateFile_js/index.html">lib/appenders/dateFile.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="17"
              data-sloc="73"
              data-bugs="0.47"
        ...
        <span class="col-md-8 file-chart js-file-chart"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_appenders_fileSync_js/index.html">lib/appenders/fileSync.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="16"
              data-sloc="189"
              data-bugs="1.47"
        ...
        <span class="col-md-8 file-chart js-file-chart"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_appenders_logLevelFilter_js/index.html">lib/appenders/logLevelFilter.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="7"
              data-sloc="23"
              data-bugs="0.19"
        ...
        <span class="col-md-8 file-chart js-file-chart"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_appenders_logstashUDP_js/index.html">lib/appenders/logstashUDP.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="12"
              data-sloc="50"
              data-bugs="0.43"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_appenders_multiprocess_js/index.html">lib/appenders/multiprocess.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="8"
              data-sloc="134"
              data-bugs="0.96"
        ...
        <span class="col-md-8 file-chart js-file-chart"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_debug_js/index.html">lib/debug.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="5"
              data-sloc="15"
              data-bugs="0.07"
        ...
        <span class="col-md-8 file-chart js-file-chart"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_streams_BaseRollingFileStream_js/index.html">lib/streams/BaseRollingFileStream.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="14"
              data-sloc="93"
              data-bugs="0.70"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_streams_DateRollingFileStream_js/index.html">lib/streams/DateRollingFileStream.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="14"
              data-sloc="95"
              data-bugs="0.82"
            ...
            <li class="col-md-12">
                <div class="row">
                    <span class="fade-left fadeout visible-large"></span>
                    <span class="col-md-4 file"><a class="file-link"
                                                   href="./files/lib_streams_RollingFileStream_js/index.html">lib/streams/RollingFileStream.js</a></span>
        <span class="col-md-8 file-chart js-file-chart"
              data-lint="18"
              data-sloc="118"
              data-bugs="1.04"
