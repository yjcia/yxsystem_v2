        ...
        <div class="col-md-4">
            <div class="reportBlock maintainabilityList">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <strong>62 score</strong>
                        <small>lib/connect-logger.js</small>
                    </li>

                    <li>
                        <strong>62 score</strong>
                        <small>lib/date_format.js</small>
                    </li>

                    <li>
                        <strong>65 score</strong>
                        <small>lib/streams/DateRollingFileStream.js</small>
                    </li>

                    <li>
                        <strong>67 score</strong>
                        <small>lib/appenders/clustered.js</small>
                    </li>

                    <li>
                        <strong>68 score</strong>
                        <small>lib/appenders/gelf.js</small>
                    </li>
        ...
        <div class="col-md-4">
            <div class="reportBlock locList">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <strong>473 lines</strong>
                        <small>lib/log4js.js</small>
                    </li>

                    <li>
                        <strong>342 lines</strong>
                        <small>lib/layouts.js</small>
                    </li>

                    <li>
                        <strong>222 lines</strong>
                        <small>lib/connect-logger.js</small>
                    </li>

                    <li>
                        <strong>189 lines</strong>
                        <small>lib/appenders/fileSync.js</small>
                    </li>

                    <li>
                        <strong>144 lines</strong>
                        <small>lib/appenders/gelf.js</small>
                    </li>
        ...
        <div class="col-md-4">
            <div class="reportBlock lintList">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <strong>43 lint errors</strong>
                        <small>lib/log4js.js</small>
                    </li>

                    <li>
                        <strong>22 lint errors</strong>
                        <small>lib/appenders/file.js</small>
                    </li>

                    <li>
                        <strong>19 lint errors</strong>
                        <small>lib/appenders/smtp.js</small>
                    </li>

                    <li>
                        <strong>18 lint errors</strong>
                        <small>lib/streams/RollingFileStream.js</small>
                    </li>

                    <li>
                        <strong>17 lint errors</strong>
                        <small>lib/appenders/dateFile.js</small>
                    </li>
