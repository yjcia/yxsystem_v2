...
!function (e) {
    ...
    function n(e) {
        ...
        var C, M = 0, T = a.prototype, q = new a(1), P = 20, k = 4, B = -7, $ = 21, G = -1e7, z = 1e7, j = !0, H = F, V = !1, W = 1, J = 100, X = {
            decimalSeparator: ".",
            groupSeparator: ",",
            groupSize: 3,
                ...
                if (L[h] > (I[h] || 0) && c--, 0 > F)b.push(1), g = !0; else {
                    ...
                    do {
                        if (p = 0, l = n(L, O, _, S), 0 > l) {
                            if (R = O[0], _ != S && (R = R * f + (O[1] || 0)), p = m(R / D), p > 1)for (p >= f && (p = f - 1), d = e(L, p, f), w = d.length, S = O.length; 1 == n(d, O, w, S);)p--, r(d, w > _ ? x : L, w, f), w = d.length, l = 1; else 0 == p && (l = p = 1), d = L.slice(), w = d.length;
                            if (S > w && d.unshift(0), r(O, d, S, f), S = O.length, -1 == l)for (; n(L, O, _, S) < 1;)p++, r(O, S > _ ? x : L, S, f), S = O.length
                        } else 0 === l && (p++, O = [0]);
