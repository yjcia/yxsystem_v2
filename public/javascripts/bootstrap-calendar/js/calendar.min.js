...
Date.prototype.getWeek = function () {
    ...
    function r(t, e) {
        var a = t % 19, o = Math.floor(t / 100), n = t % 100, i = Math.floor(o / 4), s = o % 4, r = Math.floor((o + 8) / 25), l = Math.floor((o - r + 1) / 3), d = (19 * a + o - i - l + 15) % 30, h = Math.floor(n / 4), p = n % 4, c = (32 + 2 * s + 2 * h - d - p) % 7, u = Math.floor((a + 11 * d + 22 * c) / 451), m = d + c + 7 * u + 114, y = Math.floor(m / 31) - 1, g = m % 31 + 1;
        return new Date(t, y, g + (e ? e : 0), 0, 0, 0)
    }
    ...
    o.cache = {}, i.prototype.setOptions = function (e) {
        ...
        var t = {};
        t.cal = this, t.day = 1, t.months = 1 == a(this, "first_day") ? [this.locale.d1, this.locale.d2, this.locale.d3, this.locale.d4, this.locale.d5, this.locale.d6, this.locale.d0] : [this.locale.d0, this.locale.d1, this.locale.d2, this.locale.d3, this.locale.d4, this.locale.d5, this.locale.d6];
        ...
        (i >= 1 && 0 != i % 1 || 1 > i && 0 != 1440 / o % 1) && t.error(this.locale.error_timedevide);
        ...
        var c = new Date(this.options.position.start.getTime());
        c.setHours(l[0]), c.setMinutes(l[1]), e.all_day = [], e.by_hour = [], e.after_time = [], e.before_time = [], t.each(e.events, function (t, o) {
            ...
            if (o.start_hour = ("" + i.getHours()).formatNum(2) + ":" + ("" + i.getMinutes()).formatNum(2), o.end_hour = ("" + s.getHours()).formatNum(2) + ":" + ("" + s.getMinutes()).formatNum(2), o.start < p.getTime() && (n(1), o.start_hour = i.getDate() + " " + a.locale["ms" + i.getMonth()] + " " + o.start_hour), o.end > c.getTime() && (n(1), o.end_hour = s.getDate() + " " + a.locale["ms" + s.getMonth()] + " " + o.end_hour), o.start < p.getTime() && o.end > c.getTime())return e.all_day.push(o), void 0;
        ...
        return t.each(this.getEventsBetween(o, n), function (t, e) {
            e.start_day = new Date(parseInt(e.start)).getDay(), 1 == r && (e.start_day = (e.start_day + 6) % 7), e.days = 864e5 >= e.end - e.start ? 1 : (e.end - e.start) / 864e5, o > e.start && (e.days = e.days - (o - e.start) / 864e5, e.start_day = 0), e.days = Math.ceil(e.days), e.start_day + e.days > 7 && (e.days = 7 - e.start_day), i.push(e)
        ...
        if (t("a[data-event-id]", this.context).unbind("click"), e.options.modal) {
            ...
            if (a.length) {
                ...
                "iframe" == e.options.modal_type && (o = t(document.createElement("iframe")).attr({
                    ...
                    "iframe" == e.options.modal_type && (o.attr("src", i), t(".modal-body", a).html(o)), (!a.data("handled.bootstrap-calendar") || a.data("handled.bootstrap-calendar") && a.data("handled.event-id") != n.id) && a.on("show.bs.modal", function () {
        ...
        t(".cal-month-box .cal-row-fluid").on("mouseenter", function () {
            ...
            n.setDate(parseInt(s)), s = 10 > s ? "0" + s : s, a.html(e.locale.week.format(n.getWeek())), a.attr("data-cal-week", o + s).show().appendTo(i)
        }).on("mouseleave", function () {
            a.hide()
        }), a.click(function () {
            e.options.day = t(this).data("cal-week"), e.view("week")
        }), t("a.event").mouseenter(function () {
            t('a[data-event-id="' + t(this).data("event-id") + '"]').closest(".cal-cell1").addClass("day-highlight dh-" + t(this).data("event-class"))
        }), t("a.event").mouseleave(function () {
            t("div.cal-cell1").removeClass("day-highlight dh-" + t(this).data("event-class"))
        })
