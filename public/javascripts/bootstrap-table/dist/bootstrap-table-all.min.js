...
!function (a) {
                ...
                if (c = "hidden", d = [], h.visible) {
                    ...
                    if (g.$header.find(b('.th-inner:eq("%s")', f)).next().append(d.join("")), void 0 !== h.filterData && "column" !== h.filterData.toLowerCase()) {
                        ...
                        switch (k.append(a("<option></option>").attr("value", "").text("")), i) {
                            case"url":
                                a.ajax({
                                    url: j, dataType: "json", success: function (b) {
        ...
        for (var b = this, e = this.getData(), f = this.pageFrom - 1; f < this.pageTo; f++) {
            ...
            a.each(this.header.fields, function (e, g) {
                ...
                if (i = d(b.header, b.header.formatters[e], [i, h, f], i), !(j.checkbox && j.radio || void 0 === j.filterControl || "select" !== j.filterControl.toLowerCase() || !j.searchable || void 0 !== j.filterData && "column" !== j.filterData.toLowerCase())) {
                    ...
                    if (void 0 !== l)if (k = l.get(0).options, 0 === k.length)l.append(a("<option></option>").attr("value", "").text("")), l.append(a("<option></option>").attr("value", i).text(i)); else {
    ...
    var d = {
        flat: function (b) {
            function c(b, e) {
                if (Object(b) !== b)d[e] = b; else if (a.isArray(b))for (var f = 0, g = b.length; g > f; f++)c(b[f], e ? e + "." + f : "" + f), 0 == g && (d[e] = []); else {
                    var h = !0;
    ...
    c.prototype.initHeader = function () {
        ...
        a(this.$el).dragtable({
            maxMovingRows: c.options.maxMovingRows, clickDelay: 200, beforeStop: function () {
                var d = [], e = [], f = -1;
    ...
    var b = !1, c = function (a) {
        ...
        if (a("#avdSearchModal").hasClass("modal"))a("#avdSearchModal").modal(); else {
